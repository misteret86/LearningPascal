...
begin
  ...
  {Test 0}
  Ergebnis := FeldMaxA(TestfeldA, 1, 4);
  ...
  {Test 1}
  Ergebnis := FeldMaxA(TestfeldA, 1, 2);
  ...
  {Test 2}
  Ergebnis := FeldMaxA(TestfeldA, 2, 3);
  ...
  {Test 3}
  Ergebnis := FeldMaxA(TestfeldA, 3, 4);
  ...
  {Test 4}
  Ergebnis := FeldMaxA(TestfeldB, 1, 2);
  ...
  {Test 5}
  Ergebnis := FeldMaxA(TestfeldB, 1, 3);
  ...
  {Test 6}
  Ergebnis := FeldMaxA(TestfeldC, 1, 3);
  ...
  {Test 7}
  Ergebnis := FeldMaxA(TestfeldD, 2, 4);
  ...
  {Test 8}
  Ergebnis := FeldMaxA(TestfeldE, 1, 3);
  ...
  {Test 9}
  Ergebnis := FeldMaxA(TestfeldF, 1, 3);
  ...
  {Test 10}
  Ergebnis := FeldMaxA(TestfeldE, 3, 4);
  ...
  {Test 11}
  Ergebnis := FeldMaxA(TestfeldB, 3, 4);
  ...
  {Test 12}
  Ergebnis := FeldMaxA(TestfeldF, 4, 4);
