...
begin
  ...
  {Test 0}
  Ergebnis := FeldMaxB(TestfeldA, 1, 4);
  ...
  {Test 1}
  Ergebnis := FeldMaxB(TestfeldA, 1, 2);
  ...
  {Test 2}
  Ergebnis := FeldMaxB(TestfeldA, 2, 3);
  ...
  {Test 3}
  Ergebnis := FeldMaxB(TestfeldA, 3, 4);
  ...
  {Test 4}
  Ergebnis := FeldMaxB(TestfeldB, 1, 2);
  ...
  {Test 5}
  Ergebnis := FeldMaxB(TestfeldB, 1, 3);
  ...
  {Test 6}
  Ergebnis := FeldMaxB(TestfeldC, 1, 3);
  ...
  {Test 7}
  Ergebnis := FeldMaxB(TestfeldD, 2, 4);
  ...
  {Test 8}
  Ergebnis := FeldMaxB(TestfeldE, 1, 3);
  ...
  {Test 9}
  Ergebnis := FeldMaxB(TestfeldF, 1, 3);
  ...
  {Test 10}
  Ergebnis := FeldMaxB(TestfeldE, 3, 4);
  ...
  {Test 11}
  Ergebnis := FeldMaxB(TestfeldB, 3, 4);
